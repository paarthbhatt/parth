            ...
            <div className="scroll-reveal delay-2 md:col-span-2 space-y-3 sm:space-y-4">
              ...
              <div className="space-y-2 sm:space-y-3 font-mono text-xs sm:text-sm">
                ...
                <div className="flex items-start gap-2 sm:gap-3">
                  <span className="text-emerald-500 flex-shrink-0">[✦]</span>
                  <p className="text-gray-300 leading-relaxed">
                    From enterprise LLM firewalls to autonomous vulnerability scanners, I engineer systems that are hardened by design and keep improving. I don&apos;t just find vulnerabilities — I architect the defenses.
                  </p>
                </div>
              </div>
